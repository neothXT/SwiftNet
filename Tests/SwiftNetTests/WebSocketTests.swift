...
final class WebSocketTests: XCTestCase {
	func testWebSocketConnection() throws {
		...
		let webSocket = SNWebSocket(url: URL(string: "wss://socketsbay.com/wss/v2/1/demo/")!)
	...
	func testWebSocketReceiveMessage() throws {
		...
		let webSocket = SNWebSocket(url: URL(string: "wss://socketsbay.com/wss/v2/1/demo/")!)
		let receiverWebSocket = SNWebSocket(url: URL(string: "wss://socketsbay.com/wss/v2/1/demo/")!)
