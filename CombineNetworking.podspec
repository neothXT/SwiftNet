#
#  Be sure to run `pod spec lint CombineNetworking.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Maciej Burdzicki" => "maciej.burdzicki@gmail.com" }
  # Or just: spec.author    = "Maciej Burdzicki"
  # spec.authors            = { "Maciej Burdzicki" => "maciej.burdzicki@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Maciej Burdzicki"
